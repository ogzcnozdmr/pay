...
class Url
{
    ...
    {
        return urlencode("{$this->ok}?paybank={$this->bank}&payorder={$this->order}&payinstallment={$this->installment}&type=ok");
    }
    ...
    {
        return urlencode("{$this->fail}?paybank={$this->bank}&payorder={$this->order}&payinstallment={$this->installment}&type=fail");
    }
